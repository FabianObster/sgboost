...
A formula object defining group base learners and individual
base learners is used in the fitting process.. Regularization is
based on the degrees of freedom of individual baselearners
...
For a data.frame `df` and a group structure `group_df`, this example fits a 
